...
<div class="col-md-12">
    ...
    <div class="container">
        ...
        <form action="{{ url('member/products') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-6">
                    <div class="card mb-5">
                        <div class="card-header bg-white d-flex justify-content-between align-items-start">
                            ...
                            <a href="{{ url('admin/products/create') }}" class="btn btn-success text-white">Add
                                Product</a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-3">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div id="imagePreview" src="" class="border" alt="placeholder image goes here">
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="images" class="text-center text-muted my-5">
                                    <div class="display-1"> <i class='bx bx-images'></i></div>
                                </div>
